// ============================================================
// Generador de Código QR en JavaScript puro (Ligero, sin dependencias)
// Adaptado para generar QR SVG y Canvas oficiales para DTE de El Salvador
// ============================================================
...
(function(root) {
  ...
  QR8BitByte.prototype = {
    ...
    write: function(buffer) {
      ...
      for (let i = 0; i < utf8.length; i++) buffer.put(utf8.charCodeAt(i), 8);
    }
  };
  ...
  QRCode.prototype = {
    ...
    make: function() {
      // Auto-determinar typeNumber si es necesario
      if (this.typeNumber < 1) {
        ...
        for (; typeNumber < 40; typeNumber++) {
          ...
          for (let i = 0; i < this.dataList.length; i++) {
            totalBits += 4 + QRUtil.getLengthInBits(this.dataList[i].mode, typeNumber) + this.dataList[i].getLength() * 8;
          }
  ...
  QRCode.generateSVG = root.generarQrSvg;
  root.QRCode = QRCode;
